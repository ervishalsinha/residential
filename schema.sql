...
CREATE TABLE users (
  ...
  payment_upi_id VARCHAR(120),
  payment_bank_account_number VARCHAR(40),
  payment_bank_ifsc VARCHAR(20),
  active_payment_method VARCHAR(10),
  razorpay_linked_account_id VARCHAR(40),
  razorpay_linked_account_status VARCHAR(30),
...
CREATE TABLE payments (
  ...
  status VARCHAR(20) NOT NULL DEFAULT 'pending',
  due_date TIMESTAMP,
  payout_method VARCHAR(10),
  payout_destination VARCHAR(255),
  gateway_channel VARCHAR(30),
  razorpay_order_id VARCHAR(64),
  razorpay_payment_id VARCHAR(64),
  razorpay_transfer_id VARCHAR(64),
  razorpay_transfer_status VARCHAR(30),
